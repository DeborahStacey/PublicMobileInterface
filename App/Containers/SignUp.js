...
export default class SignUp extends React.Component {
  ...
  login (data) {
    if (data.success === true) {
      ...
      db.post('/user/login', postObj).then((response) => NavigationActions.presentationScreen())
    } else {
      window.alert('Sign Up Failed. ' + JSON.stringify(data))
    }
  }
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.messageBox}>
            <View style={styles.messageBoxContents}>
              ...
              <TextInput ref='4' onSubmitEditing={() => this.focusNextField('5')} returnKeyType='next' onChangeText={this.updatePassword.bind(this)} placeholder='Enter your password' placeholderTextColor='white' style={styles.sectionInput} secureTextEntry />
